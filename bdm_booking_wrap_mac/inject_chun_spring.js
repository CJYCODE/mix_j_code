...
const ports = [9222, 9223, 9224, 9241];
        ...
        const script = `
            ...
            const arrayPortFieldsTimeMap = {
                9222: [
                        ...
                        {field:'A', time: "9", delay: "12"},
                        {field:'A', time: "8", delay: "180"},
                        {field:'A', time: "9", delay: "196"}
                    ],
                9223: [
                        {field:'B', time: "8", delay: "15"},
                        {field:'B', time: "8", delay: "6"},
                        {field:'B', time: "9", delay: "11"},
                        {field:'B', time: "8", delay: "180"},
                        {field:'B', time: "9", delay: "195"}
                    ],
                9224: [
                        {field:'C', time: "8", delay: "20"},
                        {field:'C', time: "8", delay: "4"},
                        {field:'C', time: "9", delay: "9"},
                        {field:'C', time: "8", delay: "182"},
                        {field:'C', time: "9", delay: "198"}
                    ],
                9228: [
                ...
                9241: [
                        {field:'D', time: "8", delay: "25"},
                        {field:'D', time: "8", delay: "7"},
                        {field:'D', time: "9", delay: "15"},
                        {field:'D', time: "8", delay: "187"},
                        {field:'D', time: "9", delay: "199"}
                    ]
            };
